...
<%
    ...
    log(WantDAO.getUsrsMatchWant(usr.getUid()).get(0).getFullName());
        ...
        <div id="frame">
            ...
            <div class="content" style="background-image: linear-gradient(to right top, #051937, #004d7a, #008793, #00bf72, #a8eb12);">
                ...
                <div id="crushOnMe" class="profile-card_chat" style="overflow: scroll; display: none;">
                    <p class="display-1 text-center" style="font-family: 'Lobster', cursive;">People following you</p>
                    <div class="py-5">
                        <div class="container">
                            <ul class="list-group font-weight-bold">
                                ...
                                <c:forEach items="${sessionScope.uList}" var="ulist">
                                    <li class="list-group-item">
                                        <div class="row">
                                            <div class="col-4">
                                                <img src="<%=usr.getAvatar()%>" style="width: 50px; height: 50px;"> ${ulist.fullName}
                                            </div>
                                            <div class="col-2">
                                                ${ulist.email}
                                            </div>
                                            ...
                                            <div class="col-4 text-right text-light">
                                                <a class="btn profile-card__buttonMenu button--orange">Crush</a>
                                                <a class="btn profile-card__buttonMenu button--blue">Remove</a>
                                            </div>
                                        </div>
                                    </li>
                                </c:forEach>
