<%-- 
    Document   : index
    Created on : Jul 1, 2019, 8:59:47 AM
    Author     : meo
--%>
                ...
                <div class="col-9 bg-light border border-success">
                    ...
                    <div class="container text-dark text-center">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th><div class="card" style="width:14rem;">
                                            <img class="card-img-top"  src="images/summit.jpg" alt="Card image">
                                            <div class="card-body">
                                                <h4 class="card-title">200.000VND</h4>
                                                <p class="card-text text-danger"><del>349.000VND</del></p>
                                                <a href="#" class="btn btn-outline-primary">Add to cart</a>
                                                <a href="#" class="btn btn-outline-success mt-2">Add to wishlist</a>
                                            </div>
                                        </div></th>
                                    <th>
                                        <div class="card" style="width:14rem;">
                                            <img class="card-img-top"  src="images/summit2.jpg" alt="Card image">
                                            <div class="card-body">
                                                <h4 class="card-title">200.000VND</h4>
                                                <p class="card-text text-danger"><del>349.000VND</del></p>
                                                <a href="#" class="btn btn-outline-primary">Add to cart</a>
                                    ...
                                    <th><div class="card" style="width:14rem;">
                                            <img class="card-img-top"  src="images/summit3.jpg" alt="Card image">
                                            <div class="card-body">
                                                <h4 class="card-title">200.000VND</h4>
                                                <p class="card-text text-danger"><del>349.000VND</del></p>
                                                <a href="#" class="btn btn-outline-primary">Add to cart</a>
