<%-- 
    Document   : cart
    Created on : Jul 1, 2019, 9:10:03 AM
    Author     : meo
--%>
            ...
            <div class="row bg-dark mb-1">
                ...
                <div class="col-4">
                    <form class="form-inline mt-2">
                        ...
                        <a href="" class="btn btn-info"><i class="fa fa-cart-plus"> 10</i></a>
                    </form>
                </div>
            </div>
            <!------------ Content----->
                        ...
                        <table class="table table-hover border mt-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>200.000VND</th>
                                    <th><a href="#"><i class="fa fa-times text-danger"> remove</i></a></th>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th><button class="btn btn-success">Checkout</button>
                                        <button class="btn btn-danger">Cancel</button></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
